      ...
      <Navbar sticky="top" className={`${style.customNav}`} expand="lg">
        ...
        <Container fluid className={`${style.navFlex}`}>
          <Form className={`d-flex align-items-center justify-center ${style.navDisplay}`}>
            <div><svg width="33" height="35" viewBox="0 0 33 35" fill="none" xmlns="http://www.w3.org/2000/svg" className={`${style.iconMobileView}`}>
              <path d="M32.75 11.0833V25.3333C32.75 27.075 31.2875 28.5 29.5 28.5H6.75L0.25 34.8333V6.33333C0.25 4.59167 1.7125 3.16667 3.5 3.16667H19.9125C19.75 3.64167 19.75 4.275 19.75 4.75C19.75 5.225 19.75 5.85833 19.9125 6.33333H3.5V25.3333H29.5V12.5083C30.6375 12.35 31.775 11.7167 32.75 11.0833ZM23 4.75C23 7.44167 25.1125 9.5 27.875 9.5C30.6375 9.5 32.75 7.44167 32.75 4.75C32.75 2.05833 30.6375 0 27.875 0C25.1125 0 23 2.05833 23 4.75Z" fill="#2A3065" />
            </svg>
            </div>
            <div className={`${style.icon}`} >
              <Dropdown>
                <Dropdown.Toggle className={style.dropdown2} variant="" id="dropdown-basic">
                  <svg xmlns="http://www.w3.org/2000/svg" width="33" height="35" fill="currentColor" className={`bi bi-bell ${style.iconMobileView}`} viewBox="0 0 16 16">
          ...
          <Navbar.Collapse id="navbarScroll">
            <Nav
              className={`mx-auto my-2 my-lg-0 text-center ${style.navLinkStyle}`}
            ...
            <Form className={`d-flex align-items-center justify-center ${style.navHidden}`}>
              <div><svg width="33" height="35" viewBox="0 0 33 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M32.75 11.0833V25.3333C32.75 27.075 31.2875 28.5 29.5 28.5H6.75L0.25 34.8333V6.33333C0.25 4.59167 1.7125 3.16667 3.5 3.16667H19.9125C19.75 3.64167 19.75 4.275 19.75 4.75C19.75 5.225 19.75 5.85833 19.9125 6.33333H3.5V25.3333H29.5V12.5083C30.6375 12.35 31.775 11.7167 32.75 11.0833ZM23 4.75C23 7.44167 25.1125 9.5 27.875 9.5C30.6375 9.5 32.75 7.44167 32.75 4.75C32.75 2.05833 30.6375 0 27.875 0C25.1125 0 23 2.05833 23 4.75Z" fill="#2A3065" />
              </svg>
              </div>
              <div className={`${style.icon}`} >
                <Dropdown>
                  <Dropdown.Toggle className={style.dropdown2} variant="" id="dropdown-basic">
                    <svg xmlns="http://www.w3.org/2000/svg" width="33" height="35" fill="currentColor" className="bi bi-bell" viewBox="0 0 16 16">
                      <path d="M8 16a2 2 0 0 0 2-2H6a2 2 0 0 0 2 2zM8 1.918l-.797.161A4.002 4.002 0 0 0 4 6c0 .628-.134 2.197-.459 3.742-.16.767-.376 1.566-.663 2.258h10.244c-.287-.692-.502-1.49-.663-2.258C12.134 8.197 12 6.628 12 6a4.002 4.002 0 0 0-3.203-3.92L8 1.917zM14.22 12c.223.447.481.801.78 1H1c.299-.199.557-.553.78-1C2.68 10.2 3 6.88 3 6c0-2.42 1.72-4.44 4.005-4.901a1 1 0 1 1 1.99 0A5.002 5.002 0 0 1 13 6c0 .88.32 4.2 1.22 6z" />
                    </svg>
                  </Dropdown.Toggle>
              ...
              <div className={`d-flex  align-items-center `} ><svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" className="bi bi-person-circle" viewBox="0 0 16 16">
                <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z" />
                <path fillRule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8zm8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1z" />
